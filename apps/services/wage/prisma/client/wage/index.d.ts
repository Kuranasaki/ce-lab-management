...
export namespace Prisma {
  ...
  */
  ...
  export interface StatementDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
     ...
     * const statementWithTaskIDOnly = await prisma.statement.findMany({ select: { taskID: true } })
     * 
     */
     ...
     * })
     * 
     * // Create many Statements and only return the `taskID`
     * const statementWithTaskIDOnly = await prisma.statement.createManyAndReturn({ 
     *   select: { taskID: true },
     *   data: [
     *     // ... provide data here
     *   ]
  ...
  interface StatementFieldRefs {
    readonly taskID: FieldRef<"Statement", 'String'>
    readonly profID: FieldRef<"Statement", 'String'>
    readonly wage: FieldRef<"Statement", 'Decimal'>
  ...
  export type StatementWhereInput = {
    ...
    taskID?: UuidFilter<"Statement"> | string
    profID?: StringFilter<"Statement"> | string
    wage?: DecimalFilter<"Statement"> | Decimal | DecimalJsLike | number | string
  ...
  export type StatementScalarWhereWithAggregatesInput = {
    ...
    taskID?: UuidWithAggregatesFilter<"Statement"> | string
    profID?: StringWithAggregatesFilter<"Statement"> | string
    wage?: DecimalWithAggregatesFilter<"Statement"> | Decimal | DecimalJsLike | number | string
  ...
  export type StatementUpdateInput = {
    ...
    profID?: StringFieldUpdateOperationsInput | string
