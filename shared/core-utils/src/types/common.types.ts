import { Static, TSchema, t as Type } from 'elysia'
...
export const PositiveIntegerSchema = Type.Numeric({ minimum: 0 })

// Pagination schema
export const PaginationParamsSchema = Type.Object({
  page: Type.Numeric({ minimum: 1, default: 1 }),
  limit: Type.Numeric({ minimum: 1, maximum: 100, default: 10 }),
